...
./silk -test.v -silk.url http://127.0.0.1:8080/api silk_create.md || travis_terminate 1;
./silk -test.v -silk.url http://127.0.0.1:8080/api silk_exceptions.md || travis_terminate 1;
